            ...
            <header className="bg-rose-900 text-stone-950 text-center items-center">
                <div className="container grid md:grid-cols-12 grid-cols-1 gap-7 mx-auto py-4 px-9">
                    ...
                    <div className="col-span-1 lg:col-span-4 flex justify-center">
                        <img
                            className="block max-h-20 md:max-h-28 lg:max-h-32 w-auto object-contain"
                            src={logo}
                            alt="GameRentals"
                        />
                    </div>
                    ...
                    <div className="lg:col-span-4 col-span-4  py-10">
                        ...
                        <nav className="flex justify-center gap-6 p-4">
                            <a href="#" className="hover:underline hover:bg-zinc-700 text-gray-500 bg-zinc-600 rounded-full px-4 py-2.5">About us</a>
                            <a href="#" className="hover:underline hover:bg-zinc-700 text-gray-500 bg-zinc-600 rounded-full px-4 py-2.5">Game Catalog</a>
                            <a href="#" className="hover:underline hover:bg-zinc-700 text-gray-500 bg-zinc-600 rounded-full px-4 py-2.5">Other</a>
                        </nav>
                    </div>
